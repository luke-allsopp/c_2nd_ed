//exercise 4.4 - extend rpc to print the top element of the stack without popping, to duplicate it, and to swap the top 2 elements. and add command to clear stack.
